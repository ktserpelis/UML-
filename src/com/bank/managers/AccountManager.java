    ...
    public void calculateInterest(LocalDate date) throws Exception{
        ...
        for (Account a : accounts) {
            ...
            if (!(a instanceof BusinessAccount)) {
                ...
                TransactionManager.getInstance().executeWithdraw(bankAccount,date, monthInterest, "Bank", "Interest Paid");
                ...
                try {
                    TransactionManager.getInstance().executeWithdraw(a,date, fee, "Bank", "Monthly Maintenance Fee");
